...
![terminal](img/prak1/langkah2.png)
...
**Jawaban :**
| Anotasi      | Fungsi                                                                                       | Kegunaan                                                                                      | Contoh                                                                                                                                    |
| ------------ | -------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| `@immutable` | Menandai bahwa class tidak boleh diubah setelah objek dibuat                                 | Digunakan agar semua field pada class bersifat `final` sehingga data tetap aman dan konsisten | `dart\n@immutable\nclass User {\n  final String name;\n  const User(this.name);\n}\n`                                                     |
| `@override`  | Menandai bahwa method/property berasal dari parent class lalu ditimpa ulang pada child class | Membantu keterbacaan kode dan mendeteksi kesalahan penulisan method                           | `dart\nclass Hewan {\n  void suara() {}\n}\n\nclass Kucing extends Hewan {\n  @override\n  void suara() {\n    print('Meong');\n  }\n}\n` |
